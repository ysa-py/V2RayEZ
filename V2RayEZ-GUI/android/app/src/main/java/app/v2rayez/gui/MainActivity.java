...
import app.v2rayez.gui.databinding.ActivityMainBinding;
...
public final class MainActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra(V2RayEZTileService.EXTRA_CONNECT_FROM_TILE, false)) {
            getIntent().removeExtra(V2RayEZTileService.EXTRA_CONNECT_FROM_TILE);
    ...
    private void requestQuickSettingsTile() {
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            manager.requestAddTileService(new ComponentName(this, V2RayEZTileService.class), getString(R.string.tile_name), Icon.createWithResource(this, R.drawable.ic_v2rayez_mono), getMainExecutor(), result -> Toast.makeText(this, R.string.tile_add_requested, Toast.LENGTH_SHORT).show());
            return;
        }
    ...
    private void openTelegram() {
        Intent direct = new Intent(Intent.ACTION_VIEW, Uri.parse("tg://resolve?domain=v2rayez"));
        ...
        try { startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/v2rayez"))); }
