...
- Added recovery for stale V2RayEZ-owned TUN adapters and failed routing sessions.
...
- Added automatic update checks at startup and every 12 hours while V2RayEZ is running.
...
- Update URLs are restricted to the official `ysa-py/V2RayEZ` GitHub repository.
...
Download the release files from [V2RayEZ 2.0.0](https://github.com/ysa-py/V2RayEZ/releases/tag/v2.0.0):

- [`V2RayEZ-v2.0.0-all-platforms.zip`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-all-platforms.zip) — Windows and Android 2.0.0 release archive.
- [`V2RayEZ-v2.0.0-Windows-x64-Installer.exe`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Windows-x64-Installer.exe) — recommended Windows installer.
- [`V2RayEZ-v2.0.0-Windows-x64.msi`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Windows-x64.msi) — Windows MSI.
- [`V2RayEZ-v2.0.0-Windows-x64-portable.zip`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Windows-x64-portable.zip) — portable Windows package.
- [`V2RayEZ-v2.0.0-Android-Universal.apk`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Android-Universal.apk) — Android universal APK containing ARMv7, ARM64, and x86_64 libraries.
- [`V2RayEZ-v2.0.0-Android-ARMv7.apk`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Android-ARMv7.apk) — 32-bit ARM APK.
- [`V2RayEZ-v2.0.0-Android-ARM64.apk`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Android-ARM64.apk) — 64-bit ARM APK.
- [`V2RayEZ-v2.0.0-Android-x86_64.apk`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Android-x86_64.apk) — x86_64 APK.
- [`V2RayEZ-v2.0.0-Android-AAB.aab`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/V2RayEZ-v2.0.0-Android-AAB.aab) — Play App Bundle.
- [`SHA256SUMS.txt`](https://github.com/ysa-py/V2RayEZ/releases/download/v2.0.0/SHA256SUMS.txt) — release checksums.

Windows binaries are currently unsigned and may trigger a SmartScreen warning. Android release packages are signed with the established V2RayEZ Android signing certificate.
...
```text
https://api.github.com/repos/ysa-py/V2RayEZ/releases/latest
```

Future releases must include:

- `V2RayEZ-v<version>-Windows-x64-Installer.exe`
- `V2RayEZ-v<version>-Android-Universal.apk`
...
4. Press **Connect**.
5. Optionally add the **V2RayEZ VPN** Quick Settings tile.

The Android application ID remains `app.v2rayez.gui` for update compatibility.
...
```powershell
$env:ANDROID_KEYSTORE_PATH = ".android-signing/v2rayez-gui.jks"
...
This creates Windows x64 installers, portable files, architecture-specific Android packages, checksums, and `V2RayEZ-v2.0.0-all-platforms.zip` under `release`.
...
V2RayEZ is an independent frontend and is not the upstream Aether project. Aether remains the networking engine and is distributed under GPL-3.0. See [NOTICE.md](NOTICE.md), [TRADEMARK.md](TRADEMARK.md), and [LICENSE](LICENSE).
