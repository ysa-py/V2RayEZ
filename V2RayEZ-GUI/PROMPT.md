V2RAYEZ GUI UPDATE — AETHER CORE v1.7.0 + SPECIFIC UI FIXES
...
Current integrated Aether core version in V2RayEZ:
...
IMPORTANT:
Upgrade the VPN engine used by V2RayEZ from Aether v1.5.0 to Aether v1.7.0.
...
Inspect the V2RayEZ project and identify exactly how Aether v1.5.0 is integrated.
