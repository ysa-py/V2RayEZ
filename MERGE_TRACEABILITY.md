...
| Rust addon/Core Manager manifest model | V2RayEZ/Aether/EasySNI Core Manager | `universal-core/src/core_manager.rs` | All | in progress | Unit tests written; compile blocked by missing Cargo |
...
| External AI blocked/unreachable fallback | `AndroidAiProviderGateway.kt`, `V2RayVpnService.kt` | in progress | Gateway returns local V2RayEZ/Aether anti-DPI fallback; VPN service invokes advisor asynchronously after probe failures. |
